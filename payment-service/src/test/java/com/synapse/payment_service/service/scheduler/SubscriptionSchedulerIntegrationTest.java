...
class SubscriptionSchedulerIntegrationTest {
    ...
    void expireSubscriptions_shouldUpdateExpiredSubscriptionsInDatabase() {
        ...
        Subscription updatedCanceledSubscription = subscriptionRepository.findById(canceledSubscription.getId()).orElseThrow();
        Subscription updatedPaymentFailedSubscription = subscriptionRepository.findById(paymentFailedSubscription.getId()).orElseThrow();
        Subscription updatedActiveSubscription = subscriptionRepository.findById(activeSubscription.getId()).orElseThrow();
    ...
    void expireSubscriptions_shouldNotProcessActiveExpiredSubscriptions() {
        ...
        // then
        Subscription unchangedSubscription = subscriptionRepository.findById(expiredActiveSubscription.getId()).orElseThrow();
